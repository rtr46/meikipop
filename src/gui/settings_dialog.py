...
class SettingsDialog(QDialog):
    def __init__(self, ocr_processor: OcrProcessor, popup_window: Popup, input_loop: InputLoop, tray_icon, parent=None):
        ...
        self.show_indonesian_check = QCheckBox()
        self.show_indonesian_check.setChecked(config.show_indonesian)
        theme_layout.addRow("  Show Indonesian:", self.show_indonesian_check)
    ...
    def save_and_accept(self):
        ...
        config.show_indonesian = self.show_indonesian_check.isChecked()
